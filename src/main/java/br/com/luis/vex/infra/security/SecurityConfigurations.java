    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/module").hasRole("INSTRUTOR")
                        .requestMatchers(HttpMethod.PUT, "/module/{id}").hasRole("INSTRUTOR")
                        .requestMatchers(HttpMethod.DELETE, "/module/{id}").hasRole("INSTRUTOR")
